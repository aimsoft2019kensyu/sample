...
@Constraint(validatedBy = { HalfWidthCharacterConstraint.class })
public @interface HalfWidthCharacter {

	String message() default "{aimsoft.halfWidthCharacter.message}";
